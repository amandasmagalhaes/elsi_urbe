...
tabela_glm_af_mulheres <- map(exposicoes, modelos) %>%
  ...
  modify_footnote(
    label ~ "Each row represents a separate model adjusted for age, race/color, and education."
  )
...
```{r}
#| label: Modelos sintomas depressivos com desenho amostral com mais ajustes
#| code-summary: "Regressão logística com desenho amostral complexo com mais ajustes"
